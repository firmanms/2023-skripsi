            ...
            <div class="col-12 d-flex align-items-center justify-content-center">
                <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-500 fmxw-500">
                    <div class="text-center text-md-center mb-4 mt-md-0">
                        <h1 class="mt-n3 mb-0 h3">{{ __('Registration Form') }}</h1>
                    </div>
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group mt-4 mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input name="name" id="name" type="name" class="form-control"
                                    placeholder="{{ __('Full Name') }}" value="{{ old('name') }}" autofocus required>
                        ...
                        <!-- Form -->
                        <div class="form-group mt-4 mb-4">
                            <label for="dateofbirth">{{ __('Birth Date') }}</label>
                            <div class="input-group">
                                <span class="input-group-text" id="basic-addon1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-calendar" viewBox="0 0 24 24"> <path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zM1 4v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4H1z"/> </svg>
                                </span>
