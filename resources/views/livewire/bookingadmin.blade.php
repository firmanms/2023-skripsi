<div>
        ...
        <div class="card card-body border-0 shadow mb-4">
            ...
            @elseif($checkinMode)
            @include('livewire.booking_checkin')
            @elseif($uploadMode)
            @include('livewire.booking_upload')
        @else
