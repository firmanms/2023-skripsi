          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry">
              ...
              <div class="entry-content">
                {!! \Illuminate\Support\Str::limit($artikel->description ?? '',200,' ...') !!}
            ...
            @endif
                {!! $artikel->description !!}--}}
                <div class="read-more">
                  <a href="{{ route('artikel.read',$artikel->slug) }}">Read More</a>
                </div>
              </div>
            ...
            <div class="sidebar">
              ...
              <div class="sidebar-item recent-posts">
                ...
                <div class="post-item clearfix">
                  ...
                  <h4><a href="{{ route('artikel.read',$artikel->slug) }}">{{ $artikelrecent->judul }}</a></h4>
